...
class MClassDef
	...
	redef var full_name is lazy do
		if is_intro then
			...
			# private gives 'p::n#::m::A' (redundnt p is ommited)
	...
	redef var c_name is lazy do
		if is_intro then
			...
			return "{mmodule.c_name}_0_{mclass.name.to_cmangle}"
		else
			return "{mmodule.c_name}_0_{mclass.c_name}"
		end
	end
...
abstract class MPropDef
	...
	redef var full_name is lazy do
		...
		if mclassdef.mclass == mproperty.intro_mclassdef.mclass then
			# intro are unabigous in a class
			res.append name
		else
