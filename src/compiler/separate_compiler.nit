...
redef class ToolContext
	...
	# --color-are-static
	var opt_color_are_static = new OptionBool("Store colors in the static data segment (slower)", "--color-are-static")
	...
	do
		...
		self.option_context.add_option(self.opt_no_shortcut_equate, opt_color_are_static)
...
class SeparateCompiler
	...
	fun compile_color_const(v: SeparateCompilerVisitor, m: Object, color: Int) do
		...
		if m isa MEntity then
			...
			else if modelbuilder.toolcontext.opt_color_are_static.value then
